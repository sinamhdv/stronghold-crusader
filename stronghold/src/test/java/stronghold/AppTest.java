...
public class AppTest {
	...
	public void testSignUpError() {
		SignupAndProfileMenuMessage erorr = SignupMenuController.signup("", "", "lk4ld", "lk4ld", "hdfyh@hghd.com", "");
	...
	public void testSignUpError12() {
		StrongHold.getUsers().add(new User("gcdyuhg", "eywy",
				"Mobina_Kochaknia34", "Mobina_Kochaknia34", "mobina.kochaknia@yahho.com", 0, 1, "hiiii"));
		SignupAndProfileMenuMessage error = SignupMenuController.signup("dasdas", "faad", "wSdd77*das", "wSdd77*das",
